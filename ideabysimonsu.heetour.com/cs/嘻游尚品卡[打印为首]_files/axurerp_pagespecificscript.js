...
var PageName = '嘻游尚品卡(打印为首)';
var PageId = 'p73d7ee19210a4883bc8292057294c07d'
var PageUrl = '嘻游尚品卡[打印为首].html'
document.title = '嘻游尚品卡(打印为首)';
...
if (true) {
	...
	self.location.href="使用说明.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="终端机前端.html" + GetQuerystring();
