...
var PageName = '添加/修改周边游';
var PageId = 'p38071e9b6a3c45908ef97104cd780794'
var PageUrl = '添加_修改周边游.html'
document.title = '添加/修改周边游';
...
if (true) {
	...
	self.location.href="周边游价格.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="周边游后台备注.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="周边游行程表.html" + GetQuerystring();
