...
var PageName = '前台';
var PageId = 'pbb005757ef374be4882c3955593a98eb'
var PageUrl = '前台.html'
document.title = '前台';
...
if (true) {
	...
	self.location.href="不记名卡预订.html" + GetQuerystring();
...
if (true) {
	...
	NewWindow("http://www.heemall.com/" + "", "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
...
if (true) {
	...
	self.location.href="记名卡预订.html" + GetQuerystring();
