...
var PageName = 'backend';
var PageId = 'p034c1dac87f24b93923fad92d5026170'
var PageUrl = 'backend.html'
...
if (true) {
	...
	NewWindow("photo.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
...
if (true) {
	...
	self.location.href="admin-album.html" + GetQuerystring();
