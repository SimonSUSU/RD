...
var PageName = 'album-month';
var PageId = 'pf8ec0dca62634f02bb4d807f88111110'
var PageUrl = 'album-month.html'
document.title = 'album-month';
...
eval(GetDynamicPanelScript('u125', 1));
...
if (bIE) u223.attachEvent("onmouseover", MouseOveru223);
else u223.addEventListener("mouseover", MouseOveru223, true);
function MouseOveru223(e)
{
