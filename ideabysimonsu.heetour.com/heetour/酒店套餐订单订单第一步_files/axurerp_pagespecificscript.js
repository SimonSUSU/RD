...
var PageName = '酒店套餐订单订单第一步';
var PageId = 'p4bdf94a3883346259714f4eb3fbfbcf4'
var PageUrl = '酒店套餐订单订单第一步.html'
document.title = '酒店套餐订单订单第一步';
...
eval(GetDynamicPanelScript('u142', 1));
...
SetWidgetFormText('u147', PopulateVariables('刘华德'));
...
if (true) {
	...
	self.location.href="酒店套餐订单提交了.html" + GetQuerystring();
