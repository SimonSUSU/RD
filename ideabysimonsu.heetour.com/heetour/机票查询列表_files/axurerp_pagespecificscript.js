...
var PageName = '机票查询列表';
var PageId = 'p86cb6f0f69ca4dc896ce87200a2fce35'
var PageUrl = '机票查询列表.html'
document.title = '机票查询列表';
...
if (bIE) u124.attachEvent("onfocus", Focusu124);
else u124.addEventListener("focus", Focusu124, true);
function Focusu124(e)
{
...
if (bIE) u124.attachEvent("onblur", LostFocusu124);
else u124.addEventListener("blur", LostFocusu124, true);
function LostFocusu124(e)
{
...
if (bIE) u123.attachEvent("onfocus", Focusu123);
else u123.addEventListener("focus", Focusu123, true);
function Focusu123(e)
{
...
if (bIE) u123.attachEvent("onblur", LostFocusu123);
else u123.addEventListener("blur", LostFocusu123, true);
function LostFocusu123(e)
{
