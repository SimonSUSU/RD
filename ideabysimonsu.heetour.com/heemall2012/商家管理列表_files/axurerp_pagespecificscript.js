...
var PageName = '商家管理列表';
var PageId = 'p71483800e8a4458a8cc3cdcebd30b340'
var PageUrl = '商家管理列表.html'
document.title = '商家管理列表';
...
if (true) {
	...
	NewWindow("商家自助系统.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
